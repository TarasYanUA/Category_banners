...
public class FastNavigation__SingleLevel_Grid__Var1Test extends TestRunner {
    @Test(priority = 1)
    public void setConfiguration_FastNavigation__SingleLevel_Grid__Var1Test() {
        ...
        if (!$x("//a[text()='FastNavigation__SingleLevel_Grid__Var1Test']").exists()) {
            bannersManagementPage.clickBannerLinkIfExists();
            bannersManagementPage.field_Name.setValue("FastNavigation__SingleLevel_Grid__Var1Test");
    ...
    @Test(priority = 2, dependsOnMethods = "setConfiguration_FastNavigation__SingleLevel_Grid__Var1Test")
    public void check_FastNavigation__SingleLevel_Grid__Var1Test() {
        CsCart csCart = new CsCart();
        CategoryPage categoryPage = csCart.navigateToCategoryPage(1);
        categoryPage.scrollToAndScreenBanner(null, "3200 FastNavigation__SingleLevel_Grid__Var1Test - Grid");
        categoryPage.productListView_ListWithoutOptions.scrollIntoCenter().click();
        Utils.waitForSpinnerDisappear();
        categoryPage.scrollToAndScreenBanner(null, "3202 FastNavigation__SingleLevel_Grid__Var1Test - WithoutOptions");
        categoryPage.productListView_CompactList.scrollIntoCenter().click();
        Utils.waitForSpinnerDisappear();
        categoryPage.scrollToAndScreenBanner(null, "3204 FastNavigation__SingleLevel_Grid__Var1Test - CompactList");

        selectLanguage_RTL();
        categoryPage.scrollToAndScreenBanner(null, "3206 FastNavigation__SingleLevel_Grid__Var1Test - CompactList (RTL)");
        categoryPage.productListView_ListWithoutOptions.scrollIntoCenter().click();
        Utils.waitForSpinnerDisappear();
        categoryPage.scrollToAndScreenBanner(null, "3208 FastNavigation__SingleLevel_Grid__Var1Test - WithoutOptions (RTL)");
        categoryPage.productListView_Grid.scrollIntoCenter().click();
        Utils.waitForSpinnerDisappear();
        categoryPage.scrollToAndScreenBanner(null, "3210 FastNavigation__SingleLevel_Grid__Var1Test - Grid (RTL)");
    }
}