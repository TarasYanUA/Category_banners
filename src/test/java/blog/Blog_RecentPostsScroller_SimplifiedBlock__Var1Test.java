    ...
    public void setConfiguration_BannerType_Block__Blog_ABBlogRecentPosts_SimplifiedBlock__Var1Test(){
        ...
        if(!$x("//a[text()='Blog_ABBlogRecentPosts_RecentPostsScroller_SimplifiedBlock__Var1Test']").exists()) {
            ...
            bannersManagementPage.set_BlockForBanner(BlockTitle.BLOG.value(),
                    ...
                    "",
                    "grid");
            bannersManagementPage.set_BlockForBanner(BlockTitle.BLOG.value(), "AB: Упрощенный блок", "", "without options");
            bannersManagementPage.set_BlockForBanner(BlockTitle.BLOG.value(), "AB: Упрощенный блок", "", "compact");
