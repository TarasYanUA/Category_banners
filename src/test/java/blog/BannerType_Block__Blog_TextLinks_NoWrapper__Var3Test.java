...
public class BannerType_Block__Blog_TextLinks_NoWrapper__Var3Test extends TestRunner implements Set_BlockForBanner {
    ...
    public void setConfiguration_BannerType_Block__Blog_TextLinks_NoWrapper__Var3Test(){
        ...
        if(!$x("//a[text()='blog.BannerType_Block__Blog_TextLinks_NoWrapper__Var3Test']").exists()) {
            $("a[href$='category_banner_id=1']").click();
            bannersManagementPage.clickAndType_field_Name("blog.BannerType_Block__Blog_TextLinks_NoWrapper__Var3Test");
    ...
    public void check_BannerType_Block__Blog_TextLinks_NoWrapper__Var3Test() {
        ...
        categoryPage.scrollToAndScreenBanner_TextLinks("600 blog.BannerType_Block__Blog_TextLinks_NoWrapper__Var3Test - Grid");
        categoryPage.productListView_ListWithoutOptions.hover().click();
        Selenide.sleep(2000);
        categoryPage.scrollToAndScreenBanner_TextLinks("602 blog.BannerType_Block__Blog_TextLinks_NoWrapper__Var3Test - WithoutOptions");
        categoryPage.productListView_CompactList.hover().click();
        Selenide.sleep(2000);
        categoryPage.scrollToAndScreenBanner_TextLinks("604 blog.BannerType_Block__Blog_TextLinks_NoWrapper__Var3Test - CompactList");

        shiftToRTLLanguage();
        Selenide.sleep(2000);
        categoryPage.scrollToAndScreenBanner_TextLinks("606 blog.BannerType_Block__Blog_TextLinks_NoWrapper__Var3Test - CompactList (RTL)");
        categoryPage.productListView_ListWithoutOptions.hover().click();
        Selenide.sleep(2000);
        categoryPage.scrollToAndScreenBanner_TextLinks("608 blog.BannerType_Block__Blog_TextLinks_NoWrapper__Var3Test - WithoutOptions (RTL)");
        categoryPage.productListView_Grid.hover().click();
        Selenide.sleep(2000);
        categoryPage.scrollToAndScreenBanner_TextLinks("610 blog.BannerType_Block__Blog_TextLinks_NoWrapper__Var3Test - Grid (RTL)");
    }
}