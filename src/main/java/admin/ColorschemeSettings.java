...
public class ColorschemeSettings {
    ...
    public SelenideElement activateColorscheme = $x("//div[@class=\"language-wrap\"]//a[contains(.,\"CS-Cart\")]");
...
*/
    public void set_ColorschemeSettings_Var1() {
        ...
        Utils.setCheckbox(setting_MaskForProductImages, false);
        button_Save.click();
    }
...
*/
    public void set_ColorschemeSettings_Var3() {
        ...
        Utils.setCheckbox(setting_MaskForProductImages, true);
        button_Save.click();
    }
}