...
public class Blog_ABBlogRecentPosts_RecentPosts_SecondaryFramedBlock__Var2Test extends TestRunner implements Set_BlockForBanner, SwitchOffSecondBanner {
    @Test
    public void setConfiguration_Blog_ABBlogRecentPosts_RecentPosts_SecondaryFramedBlock__Var2Test(){
        ...
        if(!$x("//a[text()='Blog_ABBlogRecentPosts_RecentPosts_SecondaryFramedBlock__Var2Test']").exists()) {
            ...
            bannersManagementPage.clickAndType_field_Name("Blog_ABBlogRecentPosts_RecentPosts_SecondaryFramedBlock__Var2Test");
