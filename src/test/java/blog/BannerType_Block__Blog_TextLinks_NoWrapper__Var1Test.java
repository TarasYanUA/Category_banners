...
public class BannerType_Block__Blog_TextLinks_NoWrapper__Var1Test extends TestRunner implements Set_BlockForBanner {
    ...
    public void setConfiguration_BannerType_Block__Blog_TextLinks_NoWrapper__Var1Test(){
        ...
        if(!$x("//a[text()='blog.BannerType_Block__Blog_TextLinks_NoWrapper__Var1Test']").exists()) {
            $("a[href$='category_banner_id=1']").click();
            bannersManagementPage.clickAndType_field_Name("blog.BannerType_Block__Blog_TextLinks_NoWrapper__Var1Test");
    ...
    public void check_BannerType_Block__Blog_TextLinks_NoWrapper__Var1Test() {
        ...
        categoryPage.scrollToAndScreenBanner_TextLinks("400 blog.BannerType_Block__Blog_TextLinks_NoWrapper__Var1Test - Grid");
        categoryPage.productListView_ListWithoutOptions.hover().click();
        Selenide.sleep(2000);
        categoryPage.scrollToAndScreenBanner_TextLinks("402 blog.BannerType_Block__Blog_TextLinks_NoWrapper__Var1Test - WithoutOptions");
        categoryPage.productListView_CompactList.hover().click();
        Selenide.sleep(2000);
        categoryPage.scrollToAndScreenBanner_TextLinks("404 blog.BannerType_Block__Blog_TextLinks_NoWrapper__Var1Test - CompactList");

        shiftToRTLLanguage();
        Selenide.sleep(2000);
        categoryPage.scrollToAndScreenBanner_TextLinks("406 blog.BannerType_Block__Blog_TextLinks_NoWrapper__Var1Test - CompactList (RTL)");
        categoryPage.productListView_ListWithoutOptions.hover().click();
        Selenide.sleep(2000);
        categoryPage.scrollToAndScreenBanner_TextLinks("408 blog.BannerType_Block__Blog_TextLinks_NoWrapper__Var1Test - WithoutOptions (RTL)");
        categoryPage.productListView_Grid.hover().click();
        Selenide.sleep(2000);
        categoryPage.scrollToAndScreenBanner_TextLinks("410 blog.BannerType_Block__Blog_TextLinks_NoWrapper__Var1Test - Grid (RTL)");
    }
}